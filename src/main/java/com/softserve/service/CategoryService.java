...
public class CategoryService {
	...
	public void loadCategories(Model model){
		model.addAttribute("categories",this.categoryRepository.findByIdParentCategoryIsNull());
		model.addAttribute("subcategories",this.categoryRepository.findByIdParentCategoryIsNotNull());
	}
